                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 md:gap-6'>
                        <div className='pb-[10px]'>
                            ...
                            <Link href={"/details"} className='flex justify-between items-center pt-[12px] hover:text-[#FF9330]'>
                                <h4 className='text-[20px] md:text-[25px] lg:text-[32px] font-semibold flex items-center gap-6 font-syne'>Basinik Finance App</h4>
                        ...
                        <div>
                            ...
                            <Link href={"/details"} className='flex justify-between items-center pt-[12px] hover:text-[#FF9330]'>
                                <h4 className='text-[20px] md:text-[25px] lg:text-[32px] font-semibold flex items-center gap-6 font-syne'>Oxilex Dashboard design</h4>
                                <span > <MdArrowOutward className='w-6 h-6 ' /> </span>
                            </Link>
                        </div>
                    </div>
