    ...
    return (
        ...
        <div className={className}>
            <div className='container  py-[100px] '>
                ...
                {button && <Link href={"/project"} className="mt-[48px] gap-2 bg-black text-white w-full h-[56px] py-[16px] rounded-lg flex items-center justify-center font-DM_Sans cursor-pointer hover:text-black hover:bg-transparent border ">View All Project <span > <MdArrowOutward className='w-6 h-6 ' /> </span> </Link>}
            </div>
        </div>
    )
}
