        ...
        <section className='bg-[#FFE9D9] pt-[140px] pb-[126px] '>
            <div className='flex items-center container' >
                ...
                <div className=' pt-[60px] left pl-[20px] lg:pl-[0px]'>
                    ...
                    <h1 className='relative font-syne leading-[110px] font-bold text-[100px]  lg:text-[140px]  pt-2  after:content-[""] after:size-[120px] after:rounded-full after:bg-yellow-400 after:absolute after:top-[6px] after:-left-[10px] after:z-[-1] w-[498px]'> <span className='bg-amber-300 w-[70px] h-[70px]'></span> <span>Ehsanul</span> Haque</h1>
