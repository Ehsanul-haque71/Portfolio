...
const Pricing = () => {
    return (
        ...
        <section className='container pb-[120px]'>
            <div className=' grid grid-cols-1 md:grid-cols-2 gap-[10px] md:gap-[30px] lg:gap-[470px]'>
                <div className='max-w-[339px] lg:min-w-[527px]'>
                    ...
                    <h2 className=' leading-[1.1] text-[40px] lg:text-[64px] font-bold font-syne pt-[10px] relative after:absolute after:rounded-full after:top-[56px] lg:after:top-[85px] after:left-[185px]  lg:after:left-[325px] z-[1] after:z-[-1] after:bg-[#FF9330] after:size-[30px] lg:after:size-[65px]'>Stay chill and pick your plan</h2>
                </div>

                <Link href={"/contacts"} className='w-fit md:w-full lg:w-fit flex items-center justify-center md:justify-center font-DM_Sans text-[14px] md:text-[18px] lg:text-[13px] leading-[1] gap-2 font-bold bg-black py-3 px-4 md:py-3 md:px-2 lg:py-4 lg:px-5 rounded-lg text-white cursor-pointer hover:bg-transparent hover:text-black border mt-[30px] md:mt-[70px] lg:mt-[110px]'>Contact for Custom Project<span > <MdArrowOutward className='w-6 h-6 ' /> </span> </Link>
