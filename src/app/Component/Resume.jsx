    ...
    return (
        <div className=' bg-[#0808080A] py-[70px] lg:pt-[100px] lg:pb-[100px] '>
            <div className='container relative z-[1]'>
                <div className=' absolute z-[10] bottom-[-50px] right-[15px] lg:top-[685px] lg:right-[-80px]'>
                    <Image className='block' src={star} alt='star_logo' />
                </div>
                <div className=' grid grid-cols-1 lg:grid-cols-2 gap-[50px] lg:gap-[134px]'>
                    {/* left */}
                    <div>
                        <p className='leading-[1.8] text-[15px] lg:text-[20px] text-[#FF9330] font-bold font-syne'>Resume</p>
                        <h2 className='leading-[1.1] text-[35px] sm:text-[26px] lg:text-[64px] max-w-[416px] font-bold font-syne pt-2 relative after:size-[35px] sm:after:size-[25px] lg:after:size-[65px] after:rounded-full after:bg-[#FF9330] after:absolute after:top-[10px] sm:after:top-[10px] lg:after:top-[12px] after:left-[2px] sm:after:left-[2px] lg:after:left-[5px] after:z-[-2]' > <span className='absolute z-[13]'></span> <span>All </span>over my details find here...</h2>
                        <div className='pt-[18px] flex flex-wrap lg:flex-col gap-3'>
                            <button onClick={() => setComponent("AboutMe")} className="bg-white text-black  text-[15px] leading-[1] max-w-[416px] max-h-[56px]  px-8 py-5 rounded-lg flex items-center justify-between font-DM_Sans cursor-pointer hover:text-white hover:bg-black border mb-2">About me <span > <MdArrowOutward className='w-6 h-6 ' /> </span> </button>

                            <button onClick={() => setComponent("Experience")} className="bg-white text-black text-[15px] leading-[1] max-w-[416px] max-h-[56px] px-8 py-5 rounded-lg flex items-center justify-between font-DM_Sans cursor-pointer hover:text-white hover:bg-black border mb-2">Experience <span > <MdArrowOutward className='w-6 h-6 ' /> </span> </button>

                            <button onClick={() => setComponent("Education")} className="bg-white text-black text-[15px] leading-[1] max-w-[416px] max-h-[56px] px-8 py-5 rounded-lg flex items-center justify-between font-DM_Sans cursor-pointer hover:text-white hover:bg-black border mb-2">Education <span > <MdArrowOutward className='w-6 h-6 ' /> </span> </button>

                            <button onClick={() => setComponent("Skills")} className="bg-white text-black text-[15px] leading-[1] max-w-[416px] max-h-[56px] px-8 py-5 rounded-lg flex items-center justify-between font-DM_Sans cursor-pointer hover:text-white hover:bg-black border mb-2">Skills <span > <MdArrowOutward className='w-6 h-6 ' /> </span> </button>

                            <button onClick={() => setComponent("Awards")} className="bg-white text-black text-[15px] leading-[1] max-w-[416px] max-h-[56px]  px-8 py-5 rounded-lg flex items-center justify-between font-DM_Sans cursor-pointer hover:text-white hover:bg-black border ">Awards <span > <MdArrowOutward className='w-6 h-6 ' /> </span> </button>
                        </div>
                    </div>
...
const AboutMe = () => {
    return (
        <div className=''>
            ...
            <p className='text-[18px] leading-[28px] font-normal font-DM_Sans text-[#08080899] max-w-[636px] pt-[24px]'>
            ...
            <div className='pt-[56px]'>
                ...
                <div className='flex pb-[16px]'>
                    ...
                    <span className='text-[24px] font-syne leading-[32px] font-bold'>+8801674087681</span>
                </div>
                <div className='flex pb-[16px]'>
                    <p className='text-[18px] leading-[28px] font-normal font-DM_Sans text-[#08080899] w-[110px] pr-[40px]'>email</p>
                    <span className='text-[24px] font-syne leading-[32px] font-bold'>hello@ehsanul.com</span>
                </div>
                <div className='flex pb-[16px]'>
...
const Experience = () => {
    return (
        <div className=''>
            ...
            <div className='grid grid grid-cols-1 sm:grid-cols-2 items-center justify-between gap-4 pt-[20px]'>
                <div className='bg-[#0808080A] rounded-2xl hover:bg-white px-[24px] pb-[24px] pt-[30px] '>
                    <div>
                        <p className='text-[14px] leading-5 text-[#080808]'>03/216 – Running</p>
                    </div>
