        ...
        <section className=' bg-[#0808080A]'>
            <div className='container py-[100px]'>
                ...
                <div className='pt-[32px] pb-[56px] flex gap-[16px] items-center justify-center'>
                    <button onClick={() => setComponent("AboutMee")} className="bg-[#0808080A] text-black w-[152px] h-[56px] px-6 py-5 rounded-lg flex items-center justify-between font-DM_Sans cursor-pointer hover:text-white hover:bg-black mb-2">About me <span > <MdArrowOutward className='w-6 h-6 ' /> </span> </button>

                    <button onClick={() => setComponent("EXperiences")} className="bg-[#0808080A] text-black w-[152px] h-[56px] px-6 py-5 rounded-lg flex items-center justify-between font-DM_Sans cursor-pointer hover:text-white hover:bg-black mb-2">Experience <span > <MdArrowOutward className='w-6 h-6 ' /> </span> </button>

                    <button onClick={() => setComponent("EDucation")} className="bg-[#0808080A] text-black w-[152px] h-[56px] px-6 py-5 rounded-lg flex items-center justify-between font-DM_Sans cursor-pointer hover:text-white hover:bg-black mb-2">Education <span > <MdArrowOutward className='w-6 h-6 ' /> </span> </button>

                    <button onClick={() => setComponent("SKills")} className="bg-[#0808080A]  text-black w-[152px] h-[56px] px-6 py-5 rounded-lg flex items-center justify-between font-DM_Sans cursor-pointer hover:text-white hover:bg-black mb-2">Skills <span > <MdArrowOutward className='w-6 h-6 ' /> </span> </button>

                    <button onClick={() => setComponent("AWards")} className="bg-[#0808080A]  text-black w-[152px] h-[56px] px-6 py-5 rounded-lg flex items-center justify-between font-DM_Sans cursor-pointer hover:text-white hover:bg-black ">Awards <span > <MdArrowOutward className='w-6 h-6 ' /> </span> </button>
